(function (root) {
  ...
  function abrirDetalhe(id){
    ...
    if(manual){
      ...
      h+=campo('Número da compra','ata-det-compra',a.numeroCompra,'maxlength="30"');
      h+=campo('Ano da compra','ata-det-ano-compra',a.anoCompra,'maxlength="4" inputmode="numeric"');
  ...
  function salvarDetalhe(){
    ...
    if(a.origem==='manual')Object.assign(dados,{processo:val('ata-det-processo'),objeto:val('ata-det-objeto'),numeroCompra:val('ata-det-compra'),anoCompra:val('ata-det-ano-compra'),dataAssinatura:val('ata-det-assinatura'),vigenciaInicio:val('ata-det-inicio'),vigenciaFim:val('ata-det-fim')});
