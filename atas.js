(function (root) {
  ...
  function renderEquipePreview(){var equipe=el('cfg-equipe-card'),emails=el('cfg-emails-card');if(equipe)equipe.innerHTML='<div class="cfg-row"><b>Bruno Alves</b><span class="val">Servidor · fase externa</span></div><div class="cfg-row"><b>Carla Mendes</b><span class="val">Chefia</span></div><div style="padding:12px"><button class="btn-cfg" onclick="abrirAusencias_()">Disponibilidade / férias da equipe</button></div>';if(emails)emails.innerHTML='<div class="cfg-row"><b>Bruno Alves</b><span class="val">bruno@cp2.g12.br</span></div><div class="cfg-row"><b>Carla Mendes</b><span class="val">carla@cp2.g12.br</span></div>';}
